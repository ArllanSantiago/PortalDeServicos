...
@Injectable()
export class ExtratoDemoService {
    ...
    getProcesso(filters: any[]): ResponsePagination {
        ...
        res.content = new Array<ResponseConsultaProc>(10).fill(CONSULTAPROCESSO_MOCK)
        return res
    }
    ...
    getDetalheProcesso(numproc: string):{partes:ResponseConsultaProcParte[],movimentos:ResponseConsultaProcMov[]}{
